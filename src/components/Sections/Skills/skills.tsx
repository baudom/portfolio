...
const skillCategories: SkillCategory[] = [
  {
    ...
    description: (
      <>
        <b>Skizzieren, Pixel schubsen</b> und Daten aufbereiten ist das eine,
        das <b>Gesamtpaket</b> dem Benutzer aber auch in einer&nbsp;
        <b>intuitiven und modernen</b> Benutzeroberfläche darzustellen das
        andere - Hier kann ich meiner <b>Kreativität vollen Lauf</b>
        &nbsp; lassen.
      </>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <b>automatisierten und skalierten Anwendung</b> fasziniert mich täglich
        aufs Neue - Begriffe wie&nbsp;
        <cite className="font-bold">Work&#39;s on my machine</cite> und &nbsp;
        <cite>localhost</cite> gehören schon längst der Vergangenheit an.
        <br />
