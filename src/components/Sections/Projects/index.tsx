...
const ProjectsSection: FC = async () => {
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 lg:skewed">
          ...
          >
            <ProjectList>
              <>
                ...
                <b>standortübergreifend</b>en Firmenveranstaltungen
              </>
              <>
                <b>Berechtigungssystem</b> mit&nbsp;
                <b>Microsoft Entra ID</b>&nbsp;Integration
              </>
              Dynamische Umfrageprozesse und automatisiertes Erinnerungssystem
              <>
              ...
              <>
                Modernes und&nbsp;
                <b>performantes Frontend mit Next.js</b> und Tailwind CSS,
                REST-API
              </>
            </ProjectList>
          </ProjectCard>
        ...
        <Reveal delay={400}>
          ...
          >
            <p className="mt-2 skewed-reverse md:max-w-xl">
              ...
              <sup className="text-xs">*räuspern*</sup> Text-Editor ein
              Portfolio hinzaubern?&nbsp;
              <b>Kein Problem - dachte ich.</b> Well, that escalated quickly
              -&nbsp;
